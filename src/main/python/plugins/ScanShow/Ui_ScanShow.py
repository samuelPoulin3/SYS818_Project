...
class Ui_ScanShow(object):
    def setupUi(self, ScanShow):
        ...
        self.centralwidget.setGeometry(QtCore.QRect(20, 30, 1151, 261))
        ...
        self.layer_comboBox = QtWidgets.QComboBox(self.layoutWidget)
        self.layer_comboBox.setObjectName("layer_comboBox")
        self.gridLayout_2.addWidget(self.layer_comboBox, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem3, 2, 13, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem4, 1, 13, 1, 1)
        ...
        self.result_layout.setGeometry(QtCore.QRect(80, 300, 991, 711))
        ...
        self.layer_comboBox.currentTextChanged['QString'].connect(ScanShow.on_layer_changed)
    ...
    def retranslateUi(self, ScanShow):
        ...
        self.label.setText(_translate("ScanShow", "Layer"))
